...
<div class="row">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading" style="border-bottom: 1px solid #e4e5e7; margin-bottom: 5px;">
				...
				<div class="row">
					<div class="col-md-6">
						<h3><i class="fa-fw fa fa-barcode border-right"></i> <?php echo "Customer List" ?> </h3>
					</div>
					<div class="col-md-6">
						<div class="box-icon d-flex flex-row float-right"> 
								<div class="px-2 border-left">
									<?php
										echo  anchor("create_customer/", '<i class="fa fa-plus-circle"></i>', array('class'=>'', 'title'=>'Add Customer'));
									?>
								</div>
						</div>
					</div>
...
$(document).ready(function(){
	...
	function fill_datatable(customf = ''){
	    ...
	    var customerDataTable = $(".datatable_display").DataTable({
	      ...
	      "order" : [2],
	      "ajax":{
	          url:'<?php echo base_url(); ?>'+"customer/customer/get_all_customers",
	          type: "POST",
	          data:{
	            customf : customf
	          }

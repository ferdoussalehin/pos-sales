...
<div class="panel panel-default">
	...
	<div class="panel-heading">
	  <div class="row">
		  <div class="col-md-6">
		  	 <h3> <i class="fa-fw fa fa-plus border-right"></i> <?php echo "Add Product" ?> </h3>
		  </div>
		  <div class="col-md-6">
	...
	<div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                <?php echo form_open_multipart("create_product", array("id"=>"create_product")) ?>
              ...
              <div class="form-group row">          
						...
						<select name="type" class="form-control select2" id="type" required="required">
							...
							<?php foreach($opts as $key=>$value) { ?>
								<option value="<?php echo $key; ?>" <?= $_POST['type'] == $key ? 'selected' : '' ?>><?php echo $value;?></option>
							<?php } ?>
						</select>
	                    </div>
	                    <label for="product_name" class="col-md-2"><?php echo lang('name') ?> <span class="text-danger">*</span></label>
	                    <div class="col-md-4">
	                        <input name="name" class="form-control" type="text" placeholder="<?php echo ('name') ?>" id="product_name" minlength="2" value="<?= $_POST['name'] ? $_POST['name'] : '' ?>" required="required">
	           	 		</div>
               </div>
               ...
               <div class="form-group row"> 
                        ...
                        <div class="col-md-4">
                            <input name="display_serial" class="form-control" type="text" placeholder="<?php echo ('display serial') ?>" id="" value="<?= $_POST['display_serial'] ? $_POST['display_serial'] : '' ?>">
                        </div>
	                    ...
	                    <div class="col-md-3">
							...
							?>
							<input name="code" type="text" class="form-control<?= ($Settings->use_code_for_slug ? ' gen_slug' : '') ?>" id="code"  placeholder="<?php echo ('code') ?>" value="<?= $_POST['code'] ? $_POST['code'] : '' ?>" required="required">
	            ...
	            <div class="form-group row">   
						...
						<div class="col-md-4">
							<input name="is_packed" type="checkbox" class="checkbox" id="is_packed" value="1" />
	           	 		</div> 	
               </div>
			   ...
			   <div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
	                       <input name="pack_piece" class="form-control" type="text" placeholder="<?php echo 'pack piece' ?>" id="pack_piece">
	                    </div>
	            </div>
				</div>
	                    ...
	                    <div class="col-md-4">
							<select name="category" class="form-control select" id="category" required="required">
								...
								<?php foreach($categories as $row) { ?>
									<option value="<?php echo $row->id; ?>" <?= $_POST['category'] == $row->id ? 'selected' : '' ?>><?php echo $row->name;?></option>
								<?php } ?>
							</select>
	           	 		</div>      
	                    ...
	                    <div class="col-md-4">
							<select name="unit" class="form-control select" id="unit" required="required">
								...
								<?php foreach($units as $row) { ?>
									<option value="<?php echo $row->id; ?>" <?= $_POST['unit'] == $row->id ? 'selected' : '' ?>><?php echo $row->name;?></option>
								<?php } ?>
							</select>
	                    </div>
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
	                        <input name="cost" class="form-control" type="text" placeholder="<?php echo 'product cost' ?>" id="cost" required="required" value="<?= $_POST['cost'] ? $_POST['cost'] : '' ?>">
	           	 		</div>      

	                    <label for="product_price" class="col-md-2"><?php echo lang('product_price') ?> <span class="text-danger">*</span></label>
	                    <div class="col-md-4">
	                       <input name="price" class="form-control" type="text" placeholder="<?php echo ('product price') ?>" id="price" required="required" value="<?= $_POST['price'] ? $_POST['price'] : '' ?>">
	                    </div>
	            </div>
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
	                        <input name="slug" class="form-control" type="text" placeholder="<?php echo 'slug' ?>" id="slug">
	           	 		</div>      

	                    <label for="second_name" class="col-md-2"><?php echo lang('second_name') ?> <span class="text-danger"></span></label>
	                    <div class="col-md-4">
	                       <input name="second_name" class="form-control" type="text" placeholder="<?php echo ('second name') ?>" id="second_name">
	                    </div>
	            </div>
	            ...
	            <div class="form-group row">
	                    ...
	                    <div class="col-md-4 standard_combo">
	                        <input name="weight" class="form-control" type="text" placeholder="<?php echo lang('weight') ?>" id="weight">
	           	 		</div>  
	                       ...
	                       <?php
							...
							<select name="barcode_symbology" class="form-control select" id="barcode_symbology" required="required">
								<?php foreach($bs as $key=>$value) { ?>
									<option value="<?php echo $key; ?>" <?= $key == 'code128' ? 'Selected' : '' ?>><?php echo $value;?></option>
								<?php } ?>
							</select>
	                    </div>
				...
				<div class="form-group row"> 
                        <label for="tax_rate" class="col-md-2"><?php echo lang('product_tax') ?> <span class="text-danger">*</span></label>
	                    <div class="col-md-4">
							<select name="tax_rate" class="form-control select" id="tax_rate" required="required">
	                    ...
	                    <div class="col-md-4">
							...
							<select name="tax_method" class="form-control select" id="tax_method">
	                       		<?php foreach($tm as $key => $value) { ?>
									<option value="<?php echo $key; ?>" <?= $_POST['tax_method'] == $key ? 'selected' : '' ?>><?php echo $value;?></option>
								<?php } ?>
							</select>
	                    </div>
	            </div>
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
	                        <input name="alert_quantity" class="form-control" type="text" placeholder="<?php echo 'Alert Quantity' ?>" id="alert_quantity">
	           	 		</div>      
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
							<select name="printer_selection" class="form-control select" id="unit">
								...
								<?php foreach($printers as $row) { ?>
									<option value="<?php echo $row->id; ?>" <?= $_POST['printer_selection'] == $row->id ? 'selected' : '' ?>><?php echo $row->title;?></option>
								<?php } ?>
							</select>
	           	 		</div>      
	                    ...
	                    <div class="col-md-4">
							<input name="hide_pos" type="checkbox" class="checkbox" id="hide_pos" value="1"/>
				...
				<div class="standard">
				<div class="form-group row"> 
                        <label for="product_details" class="col-md-2"><?php echo lang('product_variant') ?> <span class="text-danger"></span></label>
	                    <div class="col-md-1">
				...
				<div id="attr-con" style="display:none;">
					<div class="form-group row">
						<label for="product_details" class="col-md-2"><?php echo ('Enter variants') ?> <span class="text-danger"></span></label>
						<div class="col-md-3">
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-3">
	                       <input name="supplier_1_part_no" class="form-control" type="text" placeholder="<?php echo ('Supplier Part No.') ?>" id="supplier_1_part_no">
	                    </div>
						
	                    <div class="col-md-3">
	                       <input name="supplier_1_price" class="form-control" type="text" placeholder="<?php echo ('Supplier Price') ?>" id="supplier_1_price">
	                    </div>
	            </div>
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-3">
	                       <input name="supplier2_part_no" class="form-control" type="text" placeholder="<?php echo ('Supplier Part No.') ?>" id="supplier2_part_no">
	                    </div>
						
	                    <div class="col-md-3">
	                       <input name="supplier_2_price" class="form-control" type="text" placeholder="<?php echo ('Supplier Price') ?>" id="supplier_2_price">
	                    </div>
	            </div>
				</div>
				...
				<div class="form-group row"> 
	                    ...
	                    <div class="col-md-4">
							<textarea name="product_details" class="form-control" id="product_details">  </textarea>
	           	 		</div>      
	            </div>
...
$(document).ready(function() {
	...
	$('#addAttributes').click(function (e) {
        ...
        $(document).on('click', '.attrxxx td:not(:last-child)', function () {
            row = $(this).closest("tr");
		...
		function add_product_item(item) {
            ...
            $.each(items, function () {
                ...
                tr_html += '<td><input class="form-control text-center rquantity" name="combo_item_quantity[]" type="text" value="' + this.qty + '" data-id="' + row_no + '" data-item="' + this.id + '" id="quantity_' + row_no + '" onClick="this.select();"></td>';

...
<div class="panel panel-default">
    ...
    <div class="panel-body">
            ...
            <div class="col-md-7">
                ...
                <table id="" class="table items table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        <td>Barcode</td>
                        <td><span id="barcode">
                            <img src="<?= base_url('template/barcode/' . $product->code . '/' . $product->barcode_symbology . '/74/0'); ?>" alt="<?= $product->code; ?>" class="bcimg" />
        ...
        <div class="row px-3">
            ...
            <a href="<?= base_url('product/pdf_single_product/' . $product->id) ?>" class="col-md-3 tip btn btn-secondary" title="<?= ('Pdf') ?>">

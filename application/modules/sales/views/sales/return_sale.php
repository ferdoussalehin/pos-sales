            ...
            <div class="row" style="margin: 15px 15px;"> 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo form_input('reference_no', ($_POST['reference_no'] ?? $inv->reference_no), 'class="form-control input-tip" id="slref"'); ?>
                    </div>
                </div>
                <?php if ($Admin) {
                ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php
                            ...
                            echo form_dropdown('customer', $cus, ($_POST['customer'] ?? $inv->customer_id), 'id="slcustomer" class="form-control select2" required="required" style="width:80%;" '); 
                        ?> 
                    </div>
                </div>
            ...
            <div class="row" style="margin: 15px 15px;"> 
                <div class="col-md-12">
                    <div class="control-group table-group">
                        <label class="table-label"> <b><?= lang('order_items'); ?> *</b></label> (<?= lang('return_tip'); ?>)
            ...
            <div class="row" style="margin: 15px 15px;"> 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        echo form_dropdown('order_tax', $tr, ($_POST['order_tax'] ?? $inv->order_tax_id), 'id="sltax2" data-placeholder="' . lang('select') . ' ' . lang('order_tax') . '" class="form-control input-tip select2" style="width:100%;"'); ?>
                    </div>
                </div>
                <?php
                } ?>
                ...
                ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo form_input('order_discount', $inv->order_discount, 'class="form-control input-tip" id="sldiscount"'); ?>
                        </div>
                    </div>
                    <?php
                    } ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo form_input('shipping', $inv->shipping, 'class="form-control input-tip" id="slshipping"'); ?>

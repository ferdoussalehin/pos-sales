<div class="modal-dialog modal-lg">
        <div class="modal-content">
			...
			<h4 class="modal-title" id="aModalLabel">Edit Payment </h4>
            ...
            <div class="modal-body" id="pr_popover_content">
                ...
                echo form_open_multipart('sales/sale/updatePayment', $attrib); ?>
                <div class="row"> 
                <?php if ($Admin) {
                ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <?= form_input('date',  (isset($_POST['date']) ? $_POST['date'] : ($payment->date)), 'class="form-control datetime" id="date" required="required"'); ?>
                        </div>
                    </div>
                <?php
                } ?>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?= form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $payment->reference_no), 'class="form-control tip" id="reference_no"'); ?>
                    </div>
                </div>
                        ...
                        <div class="payment">
                            ...
                            <label for="amount"> <?= lang('amount') ?> * </label>
                                <input name="amount-paid" type="text" id="amount_1"
                                        value="<?= $this->sls->formatDecimal($payment->amount); ?>"

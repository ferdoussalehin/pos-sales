                    ...
                    <div id="receipt-data">
                       ...
                       <div class="row">
                        ...
                        <div class="row px-3 my-3 no-print">
                            <a href="<?= base_url('sales') ?>" class="col-md-3 tip btn btn-primary" title="<?= ('Sales List') ?>">
                                <i class="fa fa-barcode"></i>
                                <span class=""><?= ('Sales List') ?></span>
                            </a>
                            <a href="<?= base_url('sales/view_payments/pdf_sale/' . $inv->id) ?>" class="col-md-3 tip btn btn-secondary" title="<?= ('Pdf') ?>">
                            ...
                            <a href="<?= base_url('sales/edit/' . $inv->id) ?>" class="col-md-3 tip btn btn-warning tip" title="<?= ('Edit Product') ?>">
...
<script> 
    $(document).ready(function(){
        ...
        $(document).on('click', '#print_sale', function(){
            $.ajax({
                url: site.base_url + 'sales/sale/print_sale/<?= $inv->id ?>',
                dataType: 'html',

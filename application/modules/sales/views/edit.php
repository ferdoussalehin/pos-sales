...
if ($items) {
    echo '
        let ci = ' . json_encode($items) . ';
        $.each(ci, function() { add_invoice_item(this); });
        ';
}
?>
});
            ...
            <div class="row" style="margin: 15px 15px;"> 
                ...
                <div class="col-md-5"> 
                    <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form', 'id' => 'pos-sale-form'];
                        echo form_open('sales/pos/edit/'.$inv->id, $attrib);?>
                    <div id="left-top">
...
$(document).ready(function(){
    ...
    ?>
        if (localStorage.getItem('positemsEdit')) {
            localStorage.removeItem('positemsEdit');
        }
    ...
    $(document)
        ...
        .on('change', '.rquantity', function () {
            ...
            localStorage.setItem('positemsEdit', JSON.stringify(positems));
            loadItems();
        });
...
function loadItems() {
    if (localStorage.getItem('positemsEdit')) {
        ...
        positems = JSON.parse(localStorage.getItem('positemsEdit'));
        // let sortedItems = {};

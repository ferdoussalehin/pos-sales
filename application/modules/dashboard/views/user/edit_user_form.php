...
<div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <?php echo form_open_multipart("edit_user/$user->id", array("id"=>"create_user")) ?>
              ...
              <div class="form-group row">          
	                    ...
	                    <div class="col-md-4">
	                       <input name="firstname" class="form-control" type="text" placeholder="<?php echo lang('first_name') ?>" id="firstname" minlength="2"  value="<?php echo $user->first_name ?>">
	                    </div>
	                    <label for="lastname" class="col-md-2"><?php echo lang('last_name') ?> <span class="text-danger">*</span></label>
	                    <div class="col-md-4">
	                        <input name="lastname" class="form-control" type="text" placeholder="<?php echo lang('last_name') ?>" id="lastname" minlength="2" value="<?php echo $user->last_name ?>">
	           	 		</div>
               </div>
               ...
               <div class="form-group row"> 
                        ...
                        <div class="col-md-4">
                            <input name="username" class="form-control" type="text" placeholder="<?php echo ('Username') ?>" id="username_id" minlength="4" value="<?php echo $user->username ?>">
                        </div>
	            ...
	            <div class="form-group row">    
	                    ...
	                    <div class="col-md-4">
	                        ...
	                        <input name="phone_hidden" type="hidden" id="phone_hidden" value="<?php echo $user->phone ?>">
	           	 		</div>      
